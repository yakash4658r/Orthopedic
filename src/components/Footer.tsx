...
const SOCIALS = [
  ...
  {
    name: 'Instagram', href: 'https://www.instagram.com/ortho3trio?igsh=aHI2Y252ZGE2OHBo&utm_source=qr',
        ...
        <div>
          <div className="flex items-center gap-3 mb-4">
            <div className="w-10 h-10 flex items-center justify-center">
              <img src="/Logo.png" alt="Ortho3Trio Logo" className="w-full h-full object-contain" />
            </div>
